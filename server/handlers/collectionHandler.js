...
const getUserCollectedCollection = async (req , res) =>{
...
//find whether user alrady collect this collection or not
const deleteCollectedCollection = async (req , res) =>{
    const client = new MongoClient(MONGO_URI,options);
    const {id , sub} = req.body;
    const query = {sub:sub}
    const updateValue = {$pull : {"collection":{id:id}}} 
...
module.exports = {postCollection,getCollections,getUserCollectedCollection,deleteCollectedCollection}